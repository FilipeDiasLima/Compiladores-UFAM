...
public class Scanner {
	...
	static {
		...
		literals.put("Global", new Integer(4));
		literals.put("Function", new Integer(6));
		literals.put("End", new Integer(9));
		literals.put("Sub", new Integer(10));
		literals.put("Dim", new Integer(11));
		literals.put("If", new Integer(13));
		literals.put("ElseIf", new Integer(14));
		literals.put("Else", new Integer(15));
		literals.put("While", new Integer(16));
		literals.put("For", new Integer(17));
		literals.put("To", new Integer(18));
		literals.put("Next", new Integer(19));
		literals.put("Return", new Integer(20));
		literals.put("Print", new Integer(21));
		literals.put("Input", new Integer(22));

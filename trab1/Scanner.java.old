...
public class Scanner {
	...
	static {
		...
		literals.put("const", new Integer(4));
		literals.put("void", new Integer(7));
		...
		literals.put("else", new Integer(19));
		literals.put("return", new Integer(20));
		literals.put("printf", new Integer(21));
		literals.put("new", new Integer(33));
